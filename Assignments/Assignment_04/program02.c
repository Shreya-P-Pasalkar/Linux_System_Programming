...
{
    int fd1 = 0, fd2 = 0, iRet = 0, iSize = 0 , iOff = 0;
    ...
    iOff = lseek(fd1 , 11 , SEEK_CUR);

    if(iOff == -1)
    {
        printf("Unable to set the offset of the file\n");
        perror("Error encountered : ");
    }
    else
    {
        printf("Offset of source file set successfully\n");
    }
